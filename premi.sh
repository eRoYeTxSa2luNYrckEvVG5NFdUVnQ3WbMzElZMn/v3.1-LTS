...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/eRoYeTxSa2luNYrckEvVG5NFdUVnQ3WbMzElZMn/v3.1-LTS/main/izin | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/eRoYeTxSa2luNYrckEvVG5NFdUVnQ3WbMzElZMn/v3.1-LTS/main/izin | grep $ipsaya | awk '{print $3}')
    TIMEZONE=$(printf '%(%H:%M:%S)T')
    TEXT="
<code>────────────────────</code>
<b>✨AUTOSCRIPT PREMIUM V3.1 LTS✨</b>
<code>────────────────────</code>
...
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER SC","url":"t.me/budi_spielberg"},{"text":"GROUP","url":"t.me/+WyN3S6nUz4llNWVl"}]]}'
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}==========================================================${NC}"
echo -e "  Script Auto Installer VPS V3.1 Lts ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/eRoYeTxSa2luNYrckEvVG5NFdUVnQ3WbMzElZMn/v3.1-LTS/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/eRoYeTxSa2luNYrckEvVG5NFdUVnQ3WbMzElZMn/v3.1-LTS/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/eRoYeTxSa2luNYrckEvVG5NFdUVnQ3WbMzElZMn/v3.1-LTS/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/eRoYeTxSa2luNYrckEvVG5NFdUVnQ3WbMzElZMn/v3.1-LTS/main/"
...
wget raw.githubusercontent.com/eRoYeTxSa2luNYrckEvVG5NFdUVnQ3WbMzElZMn/v3.1-LTS/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
